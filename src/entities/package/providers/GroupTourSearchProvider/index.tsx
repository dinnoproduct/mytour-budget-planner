...
export const GrouptTourSearchProvider: React.FC<{
...
export const useGroupTourSearchContext = () => {
  const context = useContext(SearchContext);

  if (!context) {
    throw new Error(
      "useGroupTourSearchContext must be used within a GroupTourSearchProvider",
    );
  }
