import { LayoutProps, PackageBookingConfigProps } from './types.ts'
...
import { useBookingConfig, useFreeCancellation } from '@widgets/PackageBookingConfig/hooks'
...
export const PackageBookingConfig = ({
	...
	const availableSeats = useMemo<string>(() => {
		return tourPackage.availableSeats > 10 ? '10+' : tourPackage.availableSeats + ''
...

					{
						showFreeCancellation ? (
							...
							>
								...
								<Text size="sm">{t`freeCancellationUntil`} {freeCancellationDate}</Text>
							</HStack>
						) : null}
				</SectionLayout>
			) : null}
