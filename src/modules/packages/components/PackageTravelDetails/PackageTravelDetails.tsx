    ...
    <div className="travel-details-wrapper">
      ...
      >
        ...
        <div className="payment-info-modal">
          ...
          {/*  </div>*/}
          {/*) : null}*/}
          <div className="payment-cards m-t-8">
            <img className="m-r-8" src="/images/visa.svg" alt="" />
            <img className="m-r-8" src="/images/arca.svg" alt="" />
      ...
      <div className="details-buttons">
        <button className="btn-edit edit_description" onClick={onEditModalOpen}>
          <img src="/images/edit.svg" alt="" /> <span>{t('edit')}</span>
        </button>
